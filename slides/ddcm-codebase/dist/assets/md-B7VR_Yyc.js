import{B as e,C as t,O as n,Q as r,_t as i,v as a,w as o,y as s,yt as c}from"./modules/shiki-5lP-1OJ1.js";import{H as l,V as u}from"./useNav-rxqVRdK2.js";import{t as d}from"./slidev/CodeBlockWrapper-BCpfmUff.js";import{t as f}from"./default-CJKhsMWf.js";var p={__name:`slides.md__slidev_59`,setup(p){let{$slidev:m,$nav:h,$clicksContext:g,$clicks:_,$page:v,$renderContext:y,$frontmatter:b}=l();return g.setup(),(l,p)=>{let m=d;return e(),s(f,c(n(i(u)(i(b),58))),{default:r(()=>[p[1]||=a(`h1`,null,`Pipeline — GPU Acceleration`,-1),o(m,{title:``,ranges:[`16,19`]},{default:r(()=>[...p[0]||=[a(`pre`,{class:`shiki shiki-themes vitesse-dark vitesse-light slidev-code`,style:{"--shiki-dark":`#dbd7caee`,"--shiki-light":`#393a34`,"--shiki-dark-bg":`#121212`,"--shiki-light-bg":`#ffffff`}},[a(`code`,{class:`language-text`},[a(`span`,{class:`line`},[a(`span`,null,`estimate.py`)]),t(`
...
`),a(`span`,{class:`line`},[a(`span`,null,`            │      planning/backward_induction_tensor.py :: BackwardInduction  ← Metal kernels`)]),t(`
`),a(`span`,{class:`line`},[a(`span`,null,`            │`)]),t(`
`),a(`span`,{class:`line`},[a(`span`,null,`            └─ Phase 2 — NFXP optimizer loop  [every BFGS iteration]`)]),t(`
`),a(`span`,{class:`line`},[a(`span`,null,`                 neg_loglik(θ):  set_params → recompute utilities → BI → compute_exact_ll  ← fused kernel`)]),t(`
